<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modificarVotante.aspx.cs" Inherits="Examen__2.Capas.votantes.votantesmodificar" %>
...
<body>
    <form id="form1" runat="server">
        <div class="form-container">
            <h2 class="main-heading">Modificar Votante</h2>
            <div class="form-group">
                <label for="txtCedula">Cédula:</label>
                <asp:TextBox ID="txtCedula" runat="server" CssClass="input-field" Enabled="True"></asp:TextBox>
